...
class OrdersFromScriptedAccTestSuite extends MatcherSuiteBase {
  ...
  "issue asset and run test" - {
    ...
    "trading is deprecated" in {
      assertBadRequestAndResponse(
        matcherNode.placeOrder(bobAcc, aliceWavesPair, OrderType.BUY, 500, 2.GXB * Order.PriceConstant, smartTradeFee, version = 1, 10.minutes),
    ...
    "can't place an OrderV2 before the activation" in {
      assertBadRequestAndResponse(
        matcherNode.placeOrder(bobAcc, aliceWavesPair, OrderType.BUY, 500, 2.GXB * Order.PriceConstant, smartTradeFee, version = 2, 10.minutes),
    ...
    "can trade from non-scripted account" in {
      ...
      val aliceOrder =
        matcherNode.placeOrder(aliceAcc, aliceWavesPair, OrderType.SELL, 500, 2.GXB * Order.PriceConstant, matcherFee, version = 1, 10.minutes)
