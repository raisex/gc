  ...
  "check order execution" - {
    ...
    "make order and after matcher's restart try to cancel it" in {
      ...
      val aliceOrder = matcherNode
        .placeOrder(aliceAcc, aliceWavesPair, OrderType.SELL, 500, 2.GXB * Order.PriceConstant, matcherFee, orderVersion)
      ...
      orders.asks.head.price shouldBe 2.GXB * Order.PriceConstant
      ...
      orders1.asks.head.price shouldBe 2.GXB * Order.PriceConstant

      val aliceSecondOrder =
        matcherNode.placeOrder(aliceAcc, aliceWavesPair, OrderType.SELL, 500, 2.GXB * Order.PriceConstant, matcherFee, orderVersion, 5.minutes)
      ...
      orders2.asks.head.price shouldBe 2.GXB * Order.PriceConstant
