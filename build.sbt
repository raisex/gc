...
lazy val lang =
  crossProject(JSPlatform, JVMPlatform)
    ...
    .jvmSettings(
      ...
      organization := "com.wavesplatform",
      organizationName := "GXB GXBNetwork",
      organizationHomepage := Some(url("https://blackturtle.eu")),
      scmInfo := Some(ScmInfo(url("https://github.com/GXB123/GXBNetwork"), "git@github.com:GXB123/GXBNetwork.git", None)),
      developers := List(Developer("MrGXB", "Bram N.", "info@blackturtle.eu", url("https://blackturtle.eur"))),
