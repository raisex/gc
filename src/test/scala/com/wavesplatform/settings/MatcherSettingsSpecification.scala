  ...
  "MatcherSettings" should "read values" in {
    val config = loadConfig(
      ConfigFactory.parseString(
        ...
        |    ]
        |    predefined-pairs: [
        |      {amountAsset = "GXB", priceAsset = "8LQW8f7P5d5PZM7GtZEBgaqRPGSzS3DfPuiXrURJ4AJS"},
        |      {amountAsset = "DHgwrRvVyqJsepd32YbBqUeDH4GJ1N984X8QoekjgH8J", priceAsset = "GXB"},
    ...
    settings.journalDataDir should be("/GXB/matcher/journal")
    settings.snapshotsDataDir should be("/GXB/matcher/snapshots")
    ...
    settings.priceAssets should be(Seq("GXB", "8LQW8f7P5d5PZM7GtZEBgaqRPGSzS3DfPuiXrURJ4AJS", "DHgwrRvVyqJsepd32YbBqUeDH4GJ1N984X8QoekjgH8J"))
