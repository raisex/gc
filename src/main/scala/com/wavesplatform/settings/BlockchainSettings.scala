...
object FunctionalitySettings {
  ...
  val configPath = "GXB.blockchain.custom.functionality"
}
...
object BlockchainType extends Enumeration {
  val TESGXBET = Value("TESGXBET")
  val MAINNET = Value("MAINNET")
  val CUSTOM  = Value("CUSTOM")
}

object BlockchainSettings {
  val configPath: String = "GXB.blockchain"
  ...
  def fromConfig(config: Config): BlockchainSettings = {
    ...
    val (addressSchemeCharacter, functionalitySettings, genesisSettings) = blockchainType match {
      case BlockchainType.TESGXBET =>
        ('T', FunctionalitySettings.TESGXBET, GenesisSettings.TESGXBET)
      ...
      case BlockchainType.CUSTOM =>
        ...
        val functionalitySettings  = config.as[FunctionalitySettings]("GXB.blockchain.custom.functionality")
        val genesisSettings        = config.as[GenesisSettings]("GXB.blockchain.custom.genesis")
