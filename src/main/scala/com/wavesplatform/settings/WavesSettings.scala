...
object WavesSettings {
  ...
  def fromConfig(config: Config): WavesSettings = {
    ...
    val walletSettings          = config.as[WalletSettings]("GXB.wallet")
    ...
    val utxSettings             = config.as[UtxSettings]("GXB.utx")
    val featuresSettings        = config.as[FeaturesSettings]("GXB.features")
