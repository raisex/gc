...
case class MatcherApiRoute(assetPairBuilder: AssetPairBuilder,
  ...
  @ApiImplicitParams(
    Array(
      new ApiImplicitParam(name = "amountAsset", value = "Amount Asset Id in Pair, or 'GXB'", dataType = "string", paramType = "path"),
      new ApiImplicitParam(name = "priceAsset", value = "Price Asset Id in Pair, or 'GXB'", dataType = "string", paramType = "path"),
